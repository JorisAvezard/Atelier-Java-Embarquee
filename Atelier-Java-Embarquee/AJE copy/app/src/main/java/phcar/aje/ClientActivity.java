...
public class ClientActivity extends Activity {
    ...
    private static Button readVideo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        readVideo = (Button) findViewById(R.id.readVideo);
        readVideo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ClientActivity.this, VideoPlayerActivity.class);
    ...
    public void list(View v){
        ...
        for (BluetoothDevice blueDevice : receivers) {
            ...
            if(blueDevice.getName().equals("MP GETAWAY")) {
